...
export default function AIInsights() {
  ...
  const insightsQuery = trpc.aiInsights.list.useQuery(
    { limit: 20 },
    { enabled: !!user }
  );
  ...
  const getRecoveryMutation =
    trpc.aiInsights.getRecoveryRecommendations.useMutation();

  const handleGenerateInsight = async (
    type: "suggestions" | "progress" | "recovery"
  ) => {
    try {
      let result;
      if (type === "suggestions") {
      ...
      <div className="space-y-6 p-6">
        <div>
          ...
          <p className="text-muted-foreground mt-1">
            Personalized fitness analysis and recommendations
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-4">
          <Card className="border border-border/50 hover:border-border transition-colors cursor-pointer">
            ...
            <CardContent>
              <p className="text-sm text-muted-foreground mb-4">
                Get AI-powered workout ideas based on your history
              </p>
              <Button
          ...
          <Card className="border border-border/50 hover:border-border transition-colors cursor-pointer">
            ...
            <CardContent>
              <p className="text-sm text-muted-foreground mb-4">
                Analyze your 30-day progress and trends
              </p>
              <Button
        ...
        <Card className="border border-border/50">
          <CardHeader>
            ...
            <CardDescription>
              Your latest AI-generated fitness insights
            </CardDescription>
          </CardHeader>
          <CardContent>
            {insightsQuery.isLoading ? (
              ...
              <div className="text-center py-8">
                ...
                <Button onClick={() => handleGenerateInsight("suggestions")}>
          ...
          <CardContent className="space-y-3">
            ...
            <div className="flex gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  Our AI analyzes your patterns and performance
                </p>
              </div>
            </div>
            <div className="flex gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  Receive personalized suggestions to improve your fitness
                </p>
              </div>
            </div>
          </CardContent>
