...
export default function WorkoutLogger() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const workoutId =
        (workoutResult as any).insertId || (workoutResult as any)[0]?.insertId;
          ...
          <CardHeader>
            <div className="flex justify-between items-center">
              <div>
                ...
                <CardDescription>
                  Add exercises and sets to your workout
                </CardDescription>
              </div>
              <Button
                  ...
                  <div className="grid md:grid-cols-2 gap-4">
                    <div className="space-y-2">
                      ...
                      <Select
                        ...
                        onValueChange={value =>
                          handleExerciseChange(i, parseInt(value))
                        }
                      >
                        <SelectTrigger>
                    ...
                    <div className="space-y-2">
                      ...
                      <Input
                        ...
                        value={set.reps}
                        onChange={e =>
                          handleSetChange(i, "reps", parseInt(e.target.value))
                        }
                      />
                    </div>
